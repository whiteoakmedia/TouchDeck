...
extension TouchUp: TUCTouchDelegate {
    ...
    func action(for gesture: TUCCursorGesture) -> TUCCursorAction {
        ...
        case .TUCCursorGestureThreeFingerSwipeDown:
            return .appExpose
            
        // content follows the finger, like iPadOS: swipe left moves to the space on the right
        case .TUCCursorGestureThreeFingerSwipeLeft:
            return .spaceRight
            
        case .TUCCursorGestureThreeFingerSwipeRight:
            return .spaceLeft
            
        case .TUCCursorGestureThreeFingerTap:
            return .appSwitch
            
        case .TUCCursorGestureFourFingerPinchIn:
            return .quitApp
